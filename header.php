...
<div class="header">
	<div class="logo">
		<a href="index.php">SMART CASH CARRIER </a>
	</div>
</div>
...
<div class="topnav" id="myTopnav">
	...
	<a href="indexlocation.php">Location</a>
	<a style= "font-size: 21px; color: #a30303; font-weight: bold;" href="home.php" >EMERGENCY</a>
    <?php  
