...
<html>
  <head>
    <title>EMERGENCY CONTROL SYSTEM</title>
    ...
    <style>
      ...
      h4 {font-size: 0.8rem; text-align: center;}
      h3 {font-size: 0.8rem; text-align: center;}
      body {margin: 0;}
      .white{color: #FFFFFF;}
      .topnav1 {overflow: hidden; background-color: #a30303; color: white; font-size: 1.2rem;}
      .content1 {padding: 5px; }
      .card1 {background-color: white; box-shadow: 0px 0px 10px 1px rgba(140,140,140,.5); border: 1px solid #a30303; border-radius: 15px;}
      .card.header1 {background-color: #a30303; color: white; border-bottom-right-radius: 0px; border-bottom-left-radius: 0px; border-top-right-radius: 12px; border-top-left-radius: 12px;}
      .cards1 {max-width: 700px; margin: 0 auto; display: grid; grid-gap: 2rem; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr));}
  ...
  <?php include'header.php';?>
    <div class="topnav1">
      <h3>EMERGENCY CONTROL SYSTEM</h3>
    </div>
      ...
      <div class="cards1">
        ...
        <div class="card1">
          <div class="card header1">
            <h3 style="font-size: 2rem;">CASE LID</h3>
          </div>
          ...
          <p class="white"><span class="reading"><span id="ESP32_01_Temp"></span><!--<&deg;C</span></p>-->
          <!--<h4 class="humidityColor"><i class="fas fa-tint"></i> HUMIDITY</h4>-->
          <p class="white"><span class="reading"><span id="ESP32_01_Humd"></span><!-- &percnt;</span></p>-->
          <!-- *********************************************************************** -->
          
          <h4 class="temperatureColor"><span>Status Read Sensor IR : </span><br><span id="ESP32_01_Status_Read_DHT11"></span></h4>
        </div>
        <!-- ======================================================================================================= -->
        ...
        <div class="card1">
          <div class="card header1">
            <h3 style="font-size: 2rem;">CONTROLLING SYSTEM</h3>
          </div>
          
          <!-- Buttons for controlling the LEDs on Slave 2. ************************** -->
          <h4 class="LEDColor"><i class="fas fa-lightbulb"></i> Ink Degradation</h4>
          <h4><label class="switch">
            <input type="checkbox" id="ESP32_01_TogLED_01" onclick="GetTogBtnLEDState('ESP32_01_TogLED_01')">
            <div class="sliderTS"></div>
          </label></h4>
          <h4 class="LEDColor"><i class="fas fa-lightbulb"></i> Manual lock</h4>
          <h4><label class="switch">
    ...
    <br>
            ...
            <h3 style="font-size: 1.5rem; color: #FFFFFF;"> [ <span id="ESP32_01_LTRD"></span> ]</h3>
            <div class="container">
            <div class="vertical-center">
            <button type="button"><a href="http://192.168.43.223/webserial" target="_blank">SERIAL MONITOR</a></button>
            </div>
            </div>
    ...
    <script>
      ...
      function Get_Data(id) {
        ...
        xmlhttp.open("POST","getdatamain.php",true);
